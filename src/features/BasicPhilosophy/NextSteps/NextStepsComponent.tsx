...
import { ArrowRight, BookOpen, Lightbulb, Target, Rocket } from "lucide-react";
                        ...
                        <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                            ...
                            <ul className="space-y-2 text-sm">
                                <li className="flex items-start">
                                    ...
                                    <span className="text-gray-600 dark:text-gray-400">状態管理</span>
                                </li>
                                <li className="flex items-start">
                                    <span className="font-mono mr-2">useEffect</span>
                                    <span className="text-gray-600 dark:text-gray-400">副作用の処理</span>
                                </li>
                                <li className="flex items-start">
                                    <span className="font-mono mr-2">useContext</span>
                                    <span className="text-gray-600 dark:text-gray-400">コンテキストの利用</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                            ...
                            <ul className="space-y-2 text-sm">
                                <li className="flex items-start">
                                    ...
                                    <span className="text-gray-600 dark:text-gray-400">複雑な状態管理</span>
                                </li>
                                <li className="flex items-start">
                                    <span className="font-mono mr-2">useMemo</span>
                                    <span className="text-gray-600 dark:text-gray-400">計算結果のメモ化</span>
                                </li>
                                <li className="flex items-start">
                                    <span className="font-mono mr-2">useCallback</span>
                                    <span className="text-gray-600 dark:text-gray-400">関数のメモ化</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="mt-6 p-4 bg-purple-50 dark:bg-purple-950 rounded-lg">
                        <p className="text-sm text-center">
                            💡 ヒント: 左側のサイドバーから、興味のあるHooksを選んで学習することもできます
                        </p>
                    </div>
                </CardContent>
            </Card>
