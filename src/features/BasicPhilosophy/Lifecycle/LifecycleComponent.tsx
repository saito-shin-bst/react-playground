...
import { Activity, Pause, Play, RotateCw, XCircle } from "lucide-react";
...
const TimerComponent: React.FC<{ onLog: (message: string) => void }> = ({
	onLog,
}) => {
		...
		<div className="p-4 bg-indigo-50 dark:bg-indigo-950 rounded-lg border border-indigo-200 dark:border-indigo-800">
			<div className="flex items-center justify-between">
				...
				<div className="space-x-2">
					...
					<Button size="sm" onClick={() => setSeconds(0)} variant="outline">
						リセット
					</Button>
				</div>
			</div>
